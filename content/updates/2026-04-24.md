...
We are STAC-maxxers now. [https://stac.dynamical.org/catalog.json](https://stac.dynamical.org/catalog.json) contains ALL of the data used to create our documentation and drive the dynamical-catalog library. Point your robots at it for all the documentation they need to get going. STAC-as-skill.
