...
## Icechunk catalog parity on AWS Open Data
...
When Icechunk 2 is released we will make two small breaking changes:
...
The "Union of Organizations Concerned That Earth Data Is Generally Too Hard To Work With" (still workshopping this title, but it has a good _ring_ to it) just became more powerful - Earthmover launched their [Marketplace](https://earthmover.io/marketplace) and the dynamical.org catalog is within! Check it out.
