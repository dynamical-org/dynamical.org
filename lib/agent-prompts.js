 ...
 * /agent-setup/prompt.md (content/agent-setup.njk) and follows it. Same shape
 * as developers.cloudflare.com/agent-setup so people who have seen that one
 * know what it does.
 */
const SETUP_LINE = `Fetch and follow the instructions to set me up for dynamical.org's open weather and climate data from ${SETUP_PROMPT}`;
